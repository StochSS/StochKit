...
#for ssa_serial
SSA_SERIAL_SRC =  $(STOCHKIT_SRC)/drivers/ssa_serial.cpp $(COMMAND_PASS_AUX_SERIAL_OBJ) $(RANDOM_OBJ) $(PARAMETER_OBJ) $(COMMAND_LINE_INTERFACE_OBJ) $(AUTOMATIC_SELECTION_OBJ) $(STD_DRIVER_UT_OBJ) $(INPUT_OBJ) $(CONSTANT_GROUP_OBJ) $(CONSTANT_GROUP_COLLECTION_OBJ) $(NRM_BIN_HEAP_OBJ) 

#for ssa_compiled
SSA_COMPILED_SRC = $(STOCHKIT_SRC)/drivers/ssa_serial.cpp $(COMMAND_PASS_AUX_SERIAL_OBJ) $(RANDOM_OBJ) $(PARAMETER_OBJ) $(COMMAND_LINE_INTERFACE_OBJ) $(AUTOMATIC_SELECTION_OBJ) $(STD_DRIVER_UT_OBJ) $(INPUT_OBJ) $(CONSTANT_GROUP_OBJ) $(CONSTANT_GROUP_COLLECTION_OBJ) $(NRM_BIN_HEAP_OBJ) $(TRIGGER)
...
CUSTOM_SSA_SERIAL_SRC =  $(STOCHKIT_SRC)/drivers/ssa_serial.cpp $(COMMAND_PASS_AUX_SERIAL_OBJ) $(RANDOM_OBJ) $(PARAMETER_OBJ) $(COMMAND_LINE_INTERFACE_OBJ) $(AUTOMATIC_SELECTION_OBJ) $(STD_DRIVER_UT_OBJ) $(INPUT_OBJ) $(CONSTANT_GROUP_OBJ) $(CONSTANT_GROUP_COLLECTION_OBJ) $(NRM_BIN_HEAP_OBJ)

#for ssa_compiled in custom driver or output
CUSTOM_SSA_COMPILED_SRC = $(STOCHKIT_SRC)/drivers/ssa_serial.cpp $(COMMAND_PASS_AUX_SERIAL_OBJ) $(RANDOM_OBJ) $(PARAMETER_OBJ) $(COMMAND_LINE_INTERFACE_OBJ) $(AUTOMATIC_SELECTION_OBJ) $(STD_DRIVER_UT_OBJ) $(INPUT_OBJ) $(CONSTANT_GROUP_OBJ) $(CONSTANT_GROUP_COLLECTION_OBJ) $(NRM_BIN_HEAP_OBJ)
