...
LIBXML2=$(shell xml2-config --cflags)

LIBXMLINC_PATH=$(shell xml2-config --cflags)
LIBXMLLIB_PATH=$(shell xml2-config --libs)


INCLUDE_PATH=-I$(STOCHKIT_UTILITY) -I$(STOCHKIT_OUTPUT) -I$(STOCHKIT_MODEL_PARSER)  -I$(STOCHKIT_SOLVER) -I$(STOCHKIT_DRIVER) -I$(STLIB_PATH) -I$(BOOST_PATH) $(LIBXMLINC_PATH) 
...
LDFLAGS = 
LINK_PATH=-L$(BOOSTLIB_PATH) $(LIBXMLLIB_PATH)
LINK_LIBXML=
