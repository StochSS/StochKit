 ...
 *
 * $Id: SBase.h 10129 2009-08-28 12:23:22Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/SBase.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
   ...
   *
   * @param type the typecode (int) of the ancestor being sought.
   * 
   * @return the ancestor SBML object of this SBML object, that 
   * corresponds to the given typecode, NULL if none exists.
   */
   ...
   *
   * @return the version of package to which this element belongs to. 
   ...
   *
   * @return the name of package in which this element is defined.
   * "core" will be returned if this element is defined in the SBML 
	 * core. "unknown" will be returned if this element is not defined
	 * in any packages.
   */
   ...
   *
   * @return the typecode (int value) of this SBML object or @link
   ...
   * </ul>
   *
   * @warning  This function calls virtual members of this SBase element. Thus this function
   *           should only be called when it is ensured, that getTypeCode() and geNamespaces()
   *           can be expected to return correct results. Otherwise the next method should be used.
   *
   ...
   *
   * @return the plugin object (extenstion interface) of package extension
   * with the given package name or URI.
   */
  ...
  /**
   * Returns the number of plugin objects (extenstion interfaces) of
   * package extensions.
   *
  ...
  /**
   * Enables/Disables the given package with this object and other 
   * objects connected by child-parent links in the same document.
   *
   * @return integer value indicating success/failure of the
  ...
  /**
   * Predicate returning @c true if a package
   * with the given URI is enabled with this object.
   *
   ...
   * package (don't care the package version) is enabled with this object.
   *
   * @param pkgURI the URI of the package
   *
   * @return @c true if the given package is enabled with this object, @c
