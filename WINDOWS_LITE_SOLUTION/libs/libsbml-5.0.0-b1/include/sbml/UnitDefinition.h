 ...
 *
 * $Id: UnitDefinition.h 10140 2009-08-29 10:09:55Z sarahkeating $
...
public:
  ...
  /**
   * Creates a new ListOfUnitDefinitions.
   */
  ListOfUnitDefinitions (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfUnitDefinitions with SBMLNamespaces object.
   */
