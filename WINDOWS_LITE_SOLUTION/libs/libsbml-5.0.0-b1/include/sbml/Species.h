 ...
 *
 * $Id: Species.h 10171 2009-09-11 07:52:35Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/Species.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
  ...
  /**
   * Creates a new ListOfSpecies.
   */
  ListOfSpecies (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfSpecies with SBMLNamespaces object.
   */
