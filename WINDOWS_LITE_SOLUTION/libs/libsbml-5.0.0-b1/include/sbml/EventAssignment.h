 ...
 *
 * $Id: EventAssignment.h 10140 2009-08-29 10:09:55Z sarahkeating $
...
public:
  ...
  /**
   * Creates a new ListOfEventAssignments.
   */
  ListOfEventAssignments (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfEventAssignments with SBMLNamespaces object.
   */
