 ...
 *
 * $Id: SBMLDocument.h 10197 2009-09-25 15:05:08Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/SBMLDocument.h $
 *
 *<!---------------------------------------------------------------------------
...
@endverbatim
  ...
  /**
   *
   * Returns @c true if default namespace (i.e. add xmlns="..." attribute) 
   ...
   *
   * @param package the URI of the package extension.
   */
