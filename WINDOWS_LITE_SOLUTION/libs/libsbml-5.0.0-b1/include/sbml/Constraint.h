 ...
 *
 * $Id: Constraint.h 10140 2009-08-29 10:09:55Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/Constraint.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
  ...
  /**
   * Creates a new ListOfConstraints.
   */
  ListOfConstraints (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfConstraints with SBMLNamespaces object.
   */
