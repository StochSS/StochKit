 ...
 *
 * $Id: Event.h 10171 2009-09-11 07:52:35Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/Event.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
  ...
  /**
   * Creates a new ListOfEvents.
   */
  ListOfEvents (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfEvents with SBMLNamespaces object.
   */
