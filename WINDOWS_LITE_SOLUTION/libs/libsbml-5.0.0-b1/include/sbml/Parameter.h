 ...
 *
 * $Id: Parameter.h 10188 2009-09-23 11:49:40Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/Parameter.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
  ...
  /**
   * Creates a new ListOfParameters.
   */
  ListOfParameters (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfParameters with SBMLNamespaces object.
   */
