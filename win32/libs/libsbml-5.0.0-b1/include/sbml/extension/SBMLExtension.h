 ...
 *
 * $Id: SBMLExtension.h 12412 2010-12-28 23:38:03Z fbergmann $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/libsbml-5/src/extension/SBMLExtension.h $
 *
 *<!---------------------------------------------------------------------------
...
/** @endcond doxygen-libsbml-internal */
  ...
  /**
   * Returns if the given URI (package version) is supported by this 
   * package extension.
   *
   ...
   * @return the SBML level with the given URI of this package.
   */
   ...
   *
   * @param uri the string of URI that represents one of versions of layout package
   * @return the SBML version with the given URI of this package.
   */
   ...
   *
   * @param uri the string of URI that represents one of versions of this package
   * @return the package version with the given URI of this package.
   */
