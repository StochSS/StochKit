 ...
 *
 * $Id: SBMLNamespaces.h 10156 2009-09-01 12:09:35Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/SBMLNamespaces.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
   ...
   * added by this function (LIBSBML_INVALID_ATTRIBUTE_VALUE will be returned).
   * 
   * @param pkgName the string of package name (e.g. "layout", "multi")
   * @param pkgVersion the package version
