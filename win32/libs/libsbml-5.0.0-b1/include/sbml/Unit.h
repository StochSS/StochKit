 ...
 *
 * $Id: Unit.h 10177 2009-09-14 13:53:11Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/Unit.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
  ...
  /**
   * Creates a new ListOfUnits.
   */
  ListOfUnits (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfUnits with SBMLNamespaces object.
   */
