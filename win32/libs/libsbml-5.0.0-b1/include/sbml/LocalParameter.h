 ...
 *
 * $Id: LocalParameter.h 10194 2009-09-25 10:18:59Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/LocalParameter.h $
 *
 *<!---------------------------------------------------------------------------
...
public:
   ...
   *
   * @return the typecode (int) for this object, or @link SBMLTypeCode_t#SBML_UNKNOWN SBML_UNKNOWN@endlink (default).
   *
   * @see getElementName()
   */
...
public:
  ...
  /**
   * Creates a new ListOfLocalParameters.
   */
  ListOfLocalParameters (unsigned int level, unsigned int version);
          

  /**
   * Creates a new ListOfLocalParameters with SBMLNamespaces object.
   */
   ...
   * all begin with the characters @c SBML_. @endif
   * 
   * @return the typecode (int) for the objects contained in this ListOf
