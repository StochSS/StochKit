 ...
 *
 * $Id: FunctionDefinition.h 10143 2009-08-29 10:59:15Z sarahkeating $
...
public:
  ...
  /**
   * Creates a new ListOfFunctionDefinitions.
   */
  ListOfFunctionDefinitions(unsigned int level, unsigned int version);


  /**
   * Creates a new ListOfFunctionDefinitions with SBMLNamespaces object.
   */
