...
@brief Header file BinHeap class which is a helper to the SSA_NRM
*/
...
namespace STOCHKIT
{
	...
	*/
	...
	public:   
		...
		*/
		BinHeap(int n): nRxns(n), rtimes(n), whichRxn(n), heapPosition(n){}
	...
	private:
		...
		*/
		boost::numeric::ublas::unbounded_array<double> rtimes;
		...
		*/
		boost::numeric::ublas::unbounded_array<int> whichRxn;
		...
		*/
		boost::numeric::ublas::unbounded_array<int> heapPosition;
