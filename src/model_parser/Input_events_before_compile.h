...
//		customPropensityFile << "using namespace std;\n";
		...
		for(unsigned int i = 0; i < customPropensityList.size(); ++i){
			...
			customPropensityFile << "double f" << customPropensityList[i] << "(_populationVectorType& x, ParameterSet& ParametersList) {\n";
		...
		customPropensityFile << "    typedef double (*PropensityMember)(_populationVectorType&, ParameterSet&);\n";
...
//		customStateBasedTriggerFile << "using namespace std;\n";
		...
		for(unsigned int i = 0; i < customStateBasedTriggerList.size(); ++i){
			...
			customStateBasedTriggerFile << "bool _customStateTrigger" << customStateBasedTriggerList[i] << "(double t, _populationVectorType& x, ParameterSet& ParametersList) {\n";
		...
		customStateBasedTriggerFile << "    typedef boost::function<bool (double, _populationVectorType&, ParameterSet&)> TriggerMember;\n";
