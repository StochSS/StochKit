...
namespace STOCHKIT
{
 ...
 public:
  ...
  std::string getUserOutputDir() const;
  std::string getCalibratorDir() const;
  std::string getUserOutputFileName() const;
  std::string getCalibratorFileName() const;

  double getEpsilon() const;
  std::size_t getThreshold() const;
  std::size_t getSSASteps() const;

  std::string getCommandDir() const;
 ...
 private:
  ...
  std::string userOutputFileName;
  std::string calibratorDir;
  std::string calibratorFileName;
  std::string generatedCodeDir;
  std::string commandDir;

  bool recompile;
  std::string cmdArgs;

  ModelTag::ModelType modelType;
 };
}
