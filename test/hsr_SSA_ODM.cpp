...
int main()
{
  ...
  //SSA_ODM<denseVector, sparseMatrix, TestModelPropensities<denseVector> > ssa(X,NU,PROPENSITIES);//create solver object without dependency graph
  SSA_ODM<denseVector, denseMatrix, TestModelPropensities<denseVector>, graphType > ssa(X,NU,PROPENSITIES,DG);//with dependency graph
