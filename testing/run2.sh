...
output_dir_array=("dimer_decay_output_case3-" "heat_shock_mass_action_output_case3-" "heat_shock_mixed_output_case3-" "heat_shock_10x_output_case3-" "schlogl_output_case3-" "simple1p_output_case3-" "stochkit_6_reaction_mixed_output_case3-" "events1_output_case3-" "stochkit_events_output_case3-")
...
do
    ...
    do
       ...
       do
          ...
          ./ssa -m "models/examples/$model_item" -t 10 -r 10 $interval_item --out-dir "models/examples/$output_dir_item$count_pad" "$output_item" -f --seed "$seed_item" -p 7 >"$cur_dir/logs/case$count_pad/stdout3.txt" 2>&1
          let count=count+1
       done
    done
done
